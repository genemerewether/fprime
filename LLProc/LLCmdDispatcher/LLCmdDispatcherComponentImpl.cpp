...
namespace LLProc {
    ...
    LLCmdDispatcherImpl::LLCmdDispatcherImpl(const char* name) :
        LLCmdDispatcherComponentBase(name),
#else
    LLCmdDispatcherImpl::LLCmdDispatcherImpl() :
#endif
    ...
    void LLCmdDispatcherImpl::init(
            NATIVE_INT_TYPE instance /*!< The instance number*/
            ) {
        LLCmdDispatcherComponentBase::init(instance);
    }

    void LLCmdDispatcherImpl::compCmdReg_handler(NATIVE_INT_TYPE portNum, FwOpcodeType opCode) {
    ...
    void LLCmdDispatcherImpl::compCmdStat_handler(NATIVE_INT_TYPE portNum, FwOpcodeType opCode, U32 cmdSeq, Fw::CommandResponse response) {
    ...
    void LLCmdDispatcherImpl::seqCmdBuff_handler(NATIVE_INT_TYPE portNum, Fw::ComBuffer &data, U32 context) {
    ...
    void LLCmdDispatcherImpl::CMD_NO_OP_cmdHandler(FwOpcodeType opCode, U32 cmdSeq) {
    ...
    void LLCmdDispatcherImpl::CMD_NO_OP_STRING_cmdHandler(FwOpcodeType opCode, U32 cmdSeq, const Fw::CmdStringArg& arg1) {
    ...
    void LLCmdDispatcherImpl::CMD_TEST_CMD_1_cmdHandler(FwOpcodeType opCode, U32 cmdSeq, I32 arg1, F32 arg2, U8 arg3) {
    	this->log_COMMAND_TestCmd1Args(arg1,arg2,arg3);
    	this->cmdResponse_out(opCode,cmdSeq,Fw::COMMAND_OK);
    }

    void LLCmdDispatcherImpl::CMD_CLEAR_TRACKING_cmdHandler(FwOpcodeType opCode, U32 cmdSeq) {
        // clear tracking table
        for (NATIVE_INT_TYPE entry = 0; entry < LLCMD_DISPATCHER_SEQUENCER_TABLE_SIZE; entry++) {
