...
if [ -e ${QUEST_DEV_ROOT}/cross_toolchain ]; then
    ...
    LIBC_FILE=${SDFLIGHT_TOOLS_ROOT}/Qualcomm/aarch64-toolchain/sysroots/aarch64-oe-linux/usr/lib/libc.so
    ...
    echo "GROUP ( ../../lib/libc.so.6 libc_nonshared.a" >> ${LIBC_FILE}
    echo "AS_NEEDED ( ../../lib/ld-linux.so.3 ))" >> ${LIBC_FILE}
