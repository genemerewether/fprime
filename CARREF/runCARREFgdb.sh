...
screen -r "CARREF" -X stuff "gdb /golden/CARREF0\n"
screen -r "CARREF" -X stuff "handle SIGILL pass noprint nostop\n"
screen -r "CARREF" -X stuff "r -p 50100 -u 50020 -z localhost:50030 -a localhost -s"
screen -r "CARREF"
