// ====================================================================== 
// \title  PassiveL2PrmDb.hpp
// \author kubiak
// \brief  cpp file for PassiveL2PrmDb test harness implementation class
//
// \copyright
...
namespace Svc {
  ...
  Tester ::
    Tester(void) : 
      ...
      PassiveL2PrmDbGTestBase("Tester", MAX_HISTORY_SIZE),
      component("PassiveL2PrmDb", MAX_RECV_SIZE)
#else
      PassiveL2PrmDbGTestBase(MAX_HISTORY_SIZE),
...
//      PrmId    Length BufferData
    ...
    this->sendCmd_L2_PRM_PUSH_UPDATES(0, 0, PassiveL2PrmDbComponentImpl::PUSH_UPDATES);
...
//      PrmId    Length BufferData
    ...
    sendBuffOvfTest(void) 
  {
    ...
    for (int idx = 0; idx < PASSIVE_L2_PRMDB_SEND_BUFFER_ENTRIES; idx++) {
        this->clearHistory();
    ...
    this->clearHistory();
    this->invoke_to_setPrm(0, PASSIVE_L2_PRMDB_SEND_BUFFER_ENTRIES, prm.prm);

    ASSERT_EVENTS_SIZE(2);
    ASSERT_EVENTS_PrmIdAdded_SIZE(1);
    ASSERT_EVENTS_PrmIdAdded(0, PASSIVE_L2_PRMDB_SEND_BUFFER_ENTRIES);
