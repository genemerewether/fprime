// ====================================================================== 
// \title  PassiveL2PrmDb/test/ut/Tester.hpp
// \author kubiak
// \brief  hpp file for PassiveL2PrmDb test harness implementation class
//
// \copyright
...
namespace Svc {
  ...
  class Tester :
    public PassiveL2PrmDbGTestBase
  {
    ...
    private:
      ...
      //!
      PassiveL2PrmDbComponentImpl component;
