...
namespace Svc {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      //! Send a BA_DrainBuffers command
      //!
      void sendCmd_BA_DrainBuffers(
          const NATIVE_INT_TYPE instance, /*!< The instance number*/
          const U32 cmdSeq, /*!< The command sequence number*/
          U32 numToDrain, 
    ...
    protected:
      ...
      //! Handle event BA_StillDraining
      //!
      virtual void logIn_WARNING_HI_BA_StillDraining(
          U32 numDrained, 
          U32 numToDrain 
      );

      //! A history entry for event BA_StillDraining
      //!
      typedef struct {
        U32 numDrained;
        U32 numToDrain;
      } EventEntry_BA_StillDraining;

      //! The history of BA_StillDraining events
      //!
      History<EventEntry_BA_StillDraining> 
        *eventHistory_BA_StillDraining;
    ...
    protected:
      ...
      //! Handle event BA_AlreadyDraining
      //!
      virtual void logIn_WARNING_HI_BA_AlreadyDraining(
          void
      );

      //! Size of history for event BA_AlreadyDraining
      //!
      U32 eventsSize_BA_AlreadyDraining;
    ...
    protected:
      ...
      //! Handle event BA_DrainStalled
      //!
      virtual void logIn_WARNING_HI_BA_DrainStalled(
          U32 numDrained, 
          U32 numToDrain 
      );

      //! A history entry for event BA_DrainStalled
      //!
      typedef struct {
        U32 numDrained;
        U32 numToDrain;
      } EventEntry_BA_DrainStalled;

      //! The history of BA_DrainStalled events
      //!
      History<EventEntry_BA_DrainStalled> 
        *eventHistory_BA_DrainStalled;
    ...
    protected:
      ...
      //! Handle event BA_PartialDrainDone
      //!
      virtual void logIn_ACTIVITY_HI_BA_PartialDrainDone(
          U32 numDrained 
      );

      //! A history entry for event BA_PartialDrainDone
      //!
      typedef struct {
        U32 numDrained;
      } EventEntry_BA_PartialDrainDone;

      //! The history of BA_PartialDrainDone events
      //!
      History<EventEntry_BA_PartialDrainDone> 
        *eventHistory_BA_PartialDrainDone;
    ...
    protected:
      ...
      //! Handle event BA_NonBlockDrain
      //!
      virtual void logIn_WARNING_LO_BA_NonBlockDrain(
          U32 numWillDrain, 
          U32 numReqDrain 
      );

      //! A history entry for event BA_NonBlockDrain
      //!
      typedef struct {
        U32 numWillDrain;
        U32 numReqDrain;
      } EventEntry_BA_NonBlockDrain;

      //! The history of BA_NonBlockDrain events
      //!
      History<EventEntry_BA_NonBlockDrain> 
        *eventHistory_BA_NonBlockDrain;
    ...
    protected:
      ...
      //! Handle channel BA_NumQueuedBuffers
      //!
      virtual void tlmInput_BA_NumQueuedBuffers(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel BA_NumQueuedBuffers
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      } TlmEntry_BA_NumQueuedBuffers;

      //! The history of BA_NumQueuedBuffers values
      //!
      History<TlmEntry_BA_NumQueuedBuffers> 
        *tlmHistory_BA_NumQueuedBuffers;
