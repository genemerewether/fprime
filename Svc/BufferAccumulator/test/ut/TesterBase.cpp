...
namespace Svc {
...
#endif
  {
    ...
    this->tlmHistory_BA_NumQueuedBuffers = 
      new History<TlmEntry_BA_NumQueuedBuffers>(maxHistorySize);
    // Initialize event histories
#if FW_ENABLE_TEXT_LOGGING
    this->textLogHistory = new History<TextLogEntry>(maxHistorySize);
#endif
    this->eventHistory_BA_StillDraining =
      new History<EventEntry_BA_StillDraining>(maxHistorySize);
    this->eventHistory_BA_DrainStalled =
      new History<EventEntry_BA_DrainStalled>(maxHistorySize);
    this->eventHistory_BA_PartialDrainDone =
      new History<EventEntry_BA_PartialDrainDone>(maxHistorySize);
    this->eventHistory_BA_NonBlockDrain =
      new History<EventEntry_BA_NonBlockDrain>(maxHistorySize);
    ...
    ~BufferAccumulatorTesterBase(void) 
  {
    ...
    delete this->tlmHistory_BA_NumQueuedBuffers;
    // Destroy event histories
#if FW_ENABLE_TEXT_LOGGING
    delete this->textLogHistory;
#endif
    delete this->eventHistory_BA_StillDraining;
    delete this->eventHistory_BA_DrainStalled;
    delete this->eventHistory_BA_PartialDrainDone;
    delete this->eventHistory_BA_NonBlockDrain;
  }
  ...
  // ---------------------------------------------------------------------- 
  // Command: BA_DrainBuffers
  // ---------------------------------------------------------------------- 

  void BufferAccumulatorTesterBase ::
    sendCmd_BA_DrainBuffers(
        const NATIVE_INT_TYPE instance,
        const U32 cmdSeq,
        U32 numToDrain,
        BufferAccumulatorComponentBase::BlockMode blockMode
    )
  {
    ...
    Fw::CmdArgBuffer buff;
    Fw::SerializeStatus _status;
    _status = buff.serialize(numToDrain);
    FW_ASSERT(_status == Fw::FW_SERIALIZE_OK,static_cast<AssertArg>(_status));
    _status = buff.serialize((FwEnumStoreType) blockMode);
    FW_ASSERT(_status == Fw::FW_SERIALIZE_OK,static_cast<AssertArg>(_status));
    ...
    FwOpcodeType _opcode;
    const U32 idBase = this->getIdBase();
    _opcode = BufferAccumulatorComponentBase::OPCODE_BA_DRAINBUFFERS + idBase;
    ...
    )
  {
    ...
    switch (id - idBase) {
      ...
      case BufferAccumulatorComponentBase::CHANNELID_BA_NUMQUEUEDBUFFERS:
      {
        U32 arg;
        const Fw::SerializeStatus _status = val.deserialize(arg);
        if (_status != Fw::FW_SERIALIZE_OK) {
          printf("Error deserializing BA_NumQueuedBuffers: %d\n", _status);
          return;
        }
        this->tlmInput_BA_NumQueuedBuffers(timeTag, arg);
        break;
      }
  ...
  {
    this->tlmSize = 0;
    this->tlmHistory_BA_NumQueuedBuffers->clear();
  }
  ...
  void BufferAccumulatorTesterBase ::
    tlmInput_BA_NumQueuedBuffers(
        const Fw::Time& timeTag,
        const U32& val
    )
  {
    TlmEntry_BA_NumQueuedBuffers e = { timeTag, val };
    this->tlmHistory_BA_NumQueuedBuffers->push_back(e);
    ++this->tlmSize;
  }
    ...
    )
  {
    ...
    switch (id - idBase) {
      ...
      case BufferAccumulatorComponentBase::EVENTID_BA_STILLDRAINING: 
      {
...
#endif      
        _status = args.deserialize(numDrained);
        FW_ASSERT(
            _status == Fw::FW_SERIALIZE_OK,
            static_cast<AssertArg>(_status)
        );
...
#endif      
        _status = args.deserialize(numToDrain);
        FW_ASSERT(
            _status == Fw::FW_SERIALIZE_OK,
            static_cast<AssertArg>(_status)
        );

        this->logIn_WARNING_HI_BA_StillDraining(numDrained, numToDrain);

        break;

      }

      case BufferAccumulatorComponentBase::EVENTID_BA_ALREADYDRAINING: 
      {
...
#endif    
        this->logIn_WARNING_HI_BA_AlreadyDraining();

        break;

      }

      case BufferAccumulatorComponentBase::EVENTID_BA_DRAINSTALLED: 
      {
        ...
        this->logIn_WARNING_HI_BA_DrainStalled(numDrained, numToDrain);

        break;

      }

      case BufferAccumulatorComponentBase::EVENTID_BA_PARTIALDRAINDONE: 
      {
        ...
        this->logIn_ACTIVITY_HI_BA_PartialDrainDone(numDrained);

        break;

      }

      case BufferAccumulatorComponentBase::EVENTID_BA_NONBLOCKDRAIN: 
      {
...
#endif      
        _status = args.deserialize(numWillDrain);
        FW_ASSERT(
            _status == Fw::FW_SERIALIZE_OK,
            static_cast<AssertArg>(_status)
        );
...
#endif      
        _status = args.deserialize(numReqDrain);
        FW_ASSERT(
            _status == Fw::FW_SERIALIZE_OK,
            static_cast<AssertArg>(_status)
        );

        this->logIn_WARNING_LO_BA_NonBlockDrain(numWillDrain, numReqDrain);
    ...
    clearEvents(void)
  {
    ...
    this->eventHistory_BA_StillDraining->clear();
    this->eventsSize_BA_AlreadyDraining = 0;
    this->eventHistory_BA_DrainStalled->clear();
    this->eventHistory_BA_PartialDrainDone->clear();
    this->eventHistory_BA_NonBlockDrain->clear();
  }
  ...
  void BufferAccumulatorTesterBase ::
    logIn_WARNING_HI_BA_StillDraining(
        U32 numDrained,
        U32 numToDrain
    )
  {
    EventEntry_BA_StillDraining e = {
      numDrained, numToDrain
    };
    eventHistory_BA_StillDraining->push_back(e);
    ++this->eventsSize;
  }
  ...
  void BufferAccumulatorTesterBase ::
    logIn_WARNING_HI_BA_AlreadyDraining(
        void
    )
  {
    ++this->eventsSize_BA_AlreadyDraining;
    ++this->eventsSize;
  }
  ...
  void BufferAccumulatorTesterBase ::
    logIn_WARNING_HI_BA_DrainStalled(
        U32 numDrained,
        U32 numToDrain
    )
  {
    EventEntry_BA_DrainStalled e = {
      numDrained, numToDrain
    };
    eventHistory_BA_DrainStalled->push_back(e);
    ++this->eventsSize;
  }
  ...
  void BufferAccumulatorTesterBase ::
    logIn_ACTIVITY_HI_BA_PartialDrainDone(
        U32 numDrained
    )
  {
    EventEntry_BA_PartialDrainDone e = {
      numDrained
    };
    eventHistory_BA_PartialDrainDone->push_back(e);
    ++this->eventsSize;
  }
  ...
  void BufferAccumulatorTesterBase ::
    logIn_WARNING_LO_BA_NonBlockDrain(
        U32 numWillDrain,
        U32 numReqDrain
    )
  {
    EventEntry_BA_NonBlockDrain e = {
      numWillDrain, numReqDrain
    };
    eventHistory_BA_NonBlockDrain->push_back(e);
    ++this->eventsSize;
  }
