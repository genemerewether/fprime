...
#define ASSERT_TLM_BL_NumLoggedBuffers_SIZE(size) \
  this->assertTlm_BL_NumLoggedBuffers_size(__FILE__, __LINE__, size)

#define ASSERT_TLM_BL_NumLoggedBuffers(index, value) \
  this->assertTlm_BL_NumLoggedBuffers(__FILE__, __LINE__, index, value)

#define ASSERT_TLM_BL_NumLoggedBytes_SIZE(size) \
  this->assertTlm_BL_NumLoggedBytes_size(__FILE__, __LINE__, size)

#define ASSERT_TLM_BL_NumLoggedBytes(index, value) \
  this->assertTlm_BL_NumLoggedBytes(__FILE__, __LINE__, index, value)
...
#define ASSERT_EVENTS_BL_FileFlushError_SIZE(size) \
  this->assertEvents_BL_FileFlushError_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_BL_FileFlushError(index, _file, _status) \
  this->assertEvents_BL_FileFlushError(__FILE__, __LINE__, index, _file, _status)
...
namespace Svc {
    ...
    public BufferLoggerTesterBase
  {
    ...
    protected:
      ...
      //!
      void assertTlm_BL_NumLoggedBuffers_size(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 size /*!< The asserted size*/
      ) const;

      void assertTlm_BL_NumLoggedBuffers(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 index, /*!< The index*/
    ...
    protected:
      ...
      //! Assert telemetry value in history at index
      //!
      void assertTlm_BL_NumLoggedBytes_size(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 size /*!< The asserted size*/
      ) const;

      void assertTlm_BL_NumLoggedBytes(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 index, /*!< The index*/
          const U32& val /*!< The channel value*/
    ...
    protected:
      ...
      void assertEvents_BL_FileFlushError_size(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 size /*!< The asserted size*/
      ) const;

      void assertEvents_BL_FileFlushError(
          const char *const __callSiteFileName, /*!< The name of the file containing the call site*/
          const U32 __callSiteLineNumber, /*!< The line number of the call site*/
          const U32 index, /*!< The index*/
          const char *const file, /*!< The file*/
          const U32 status /*!< The Os::Status return*/
      ) const;
