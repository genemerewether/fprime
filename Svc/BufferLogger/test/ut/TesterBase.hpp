...
namespace Svc {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    protected:
      ...
      //! Handle event BL_FileFlushError
      //!
      virtual void logIn_WARNING_HI_BL_FileFlushError(
          Fw::LogStringArg& file, /*!< The file*/
          U32 status /*!< The Os::Status return*/
      );

      //! A history entry for event BL_FileFlushError
      //!
      typedef struct {
        Fw::LogStringArg file;
        U32 status;
      } EventEntry_BL_FileFlushError;

      //! The history of BL_FileFlushError events
      //!
      History<EventEntry_BL_FileFlushError> 
        *eventHistory_BL_FileFlushError;
    ...
    protected:
      ...
      //! Handle channel BL_NumLoggedBuffers
      //!
      virtual void tlmInput_BL_NumLoggedBuffers(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel BL_NumLoggedBuffers
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      } TlmEntry_BL_NumLoggedBuffers;

      //! The history of BL_NumLoggedBuffers values
      //!
      History<TlmEntry_BL_NumLoggedBuffers> 
        *tlmHistory_BL_NumLoggedBuffers;
    ...
    protected:
      ...
      //! Handle channel BL_NumLoggedBytes
      //!
      virtual void tlmInput_BL_NumLoggedBytes(
          const Fw::Time& timeTag, /*!< The time*/
          const U32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel BL_NumLoggedBytes
      //!
      typedef struct {
        Fw::Time timeTag;
        U32 arg;
      } TlmEntry_BL_NumLoggedBytes;

      //! The history of BL_NumLoggedBytes values
      //!
      History<TlmEntry_BL_NumLoggedBytes> 
        *tlmHistory_BL_NumLoggedBytes;
