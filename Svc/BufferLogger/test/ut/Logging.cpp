  ...
  namespace Logging {
      ...
      public Logging::Tester
    {
      ...
      public:
        ...
        void test(void) {
          this->component.setBaseName(Fw::EightyCharString("CloseFileTester"));
      ...
      public Logging::Tester
    {
      ...
      public:
        ...
        void test(
          ...
          /* NOTE(mereweth) - OpenFile command no longer actually opens the file
           * as of 2018/09/05
           */
          //this->sendCmd_BL_OpenFile(0, 0, baseName);
          //this->dispatchOne();
          this->component.setBaseName(Fw::EightyCharString(baseName));
