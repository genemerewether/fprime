// ======================================================================
// \title  ActiveL2PrmDb/test/ut/TesterBase.cpp
// \author Auto-generated
// \brief  cpp file for ActiveL2PrmDb component test harness base class
//
// \copyright
...
namespace Svc {
  ...
  NATIVE_INT_TYPE ActiveL2PrmDbTesterBase ::
  ...
  Fw::ParamValid ActiveL2PrmDbTesterBase ::
    invoke_to_getPrm(
        const NATIVE_INT_TYPE portNum,
        FwPrmIdType id,
        Fw::ParamBuffer &val
  ...
  Fw::InputPrmListPort *ActiveL2PrmDbTesterBase ::
  ...
  Fw::InputPrmListReadyPort *ActiveL2PrmDbTesterBase ::
  ...
  Svc::InputPingPort *ActiveL2PrmDbTesterBase ::
  ...
  Fw::InputCmdResponsePort *ActiveL2PrmDbTesterBase ::
  ...
  Fw::InputCmdRegPort *ActiveL2PrmDbTesterBase ::
  ...
  Fw::InputTimePort *ActiveL2PrmDbTesterBase ::
  ...
  Fw::InputLogPort *ActiveL2PrmDbTesterBase ::
...
#if FW_ENABLE_TEXT_LOGGING == 1
  Fw::InputLogTextPort *ActiveL2PrmDbTesterBase ::
  ...
  {
    FW_ASSERT(callComp);
    ActiveL2PrmDbTesterBase* _testerBase = 
      static_cast<ActiveL2PrmDbTesterBase*>(callComp);
  ...
  {
    ActiveL2PrmDbTesterBase* _testerBase =
      static_cast<ActiveL2PrmDbTesterBase*>(component);
  ...
  void ActiveL2PrmDbTesterBase ::
    sendCmd_L2_PRM_PUSH_UPDATES(
        const NATIVE_INT_TYPE instance,
        const U32 cmdSeq,
        ActiveL2PrmDbComponentBase::UpdateMethod updateMethod
    )
  {
    ...
    _opcode = ActiveL2PrmDbComponentBase::OPCODE_L2_PRM_PUSH_UPDATES + idBase;
    ...
    )
  {
    ...
    switch (id - idBase) {
      ...
      case ActiveL2PrmDbComponentBase::EVENTID_PRMIDNOTFOUND: 
      {
      ...
      case ActiveL2PrmDbComponentBase::EVENTID_PRMIDUPDATED: 
      {
      ...
      case ActiveL2PrmDbComponentBase::EVENTID_PRMDBFULL: 
      {
      ...
      case ActiveL2PrmDbComponentBase::EVENTID_PRMIDADDED: 
      {
      ...
      case ActiveL2PrmDbComponentBase::EVENTID_PRMSENDTOOLARGE: 
      {
      ...
      case ActiveL2PrmDbComponentBase::EVENTID_PRMSENDBUFFERFULL: 
      {
