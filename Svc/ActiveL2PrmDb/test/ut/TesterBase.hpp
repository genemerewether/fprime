// ======================================================================
// \title  ActiveL2PrmDb/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for ActiveL2PrmDb component test harness base class
//
// \copyright
...
#ifndef ActiveL2PrmDb_TESTER_BASE_HPP
#define ActiveL2PrmDb_TESTER_BASE_HPP
...
namespace Svc {
  ...
  //! \class ActiveL2PrmDbTesterBase
  //! \brief Auto-generated base class for ActiveL2PrmDb component test harness
  //!
  class ActiveL2PrmDbTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object ActiveL2PrmDbTesterBase
      //!
      virtual void init(
    ...
    protected:
      ...
      //! Construct object ActiveL2PrmDbTesterBase
      //!
      ...
      //! Destroy object ActiveL2PrmDbTesterBase
      //!
      virtual ~ActiveL2PrmDbTesterBase(void);
    ...
    protected:
      ...
      //! Send a L2_PRM_PUSH_UPDATES command
      //!
      void sendCmd_L2_PRM_PUSH_UPDATES(
    ...
    protected:
      ...
      //!
      virtual void logIn_WARNING_HI_PrmDbFull(
          U32 Id /*!< The parameter ID*/
      );
    ...
    protected:
      ...
      //! Handle event PrmSendBufferFull
      //!
      virtual void logIn_WARNING_HI_PrmSendBufferFull(
          void
      );

      //! Size of history for event PrmSendBufferFull
      //!
      U32 eventsSize_PrmSendBufferFull;
    ...
    private:
      ...
      //!
      Fw::OutputPrmListReadyPort m_to_sendPrmReady[1];
      ...
      //!
      Fw::OutputPrmListPort m_to_recvPrm[1];
    ...
    private:
      ...
      //!
      Fw::InputPrmListPort m_from_sendPrm[1];

      //! From port connected to recvPrmReady
      //!
      Fw::InputPrmListReadyPort m_from_recvPrmReady[1];
