...
static const Method methods[5] = {{REMOTE_SCALARS_MAKEX(0,0,0x0,0x0,0x0,0x0),0x0,0x0,0,0,0,0x0,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x0,0x0,0x0),0x4,0x0,1,1,(&(parameterArrays[3])),0x4,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x2,0x0,0x0),0x4,0x4,4,2,(&(parameterArrays[1])),0x4,0x4},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x2,0x0,0x0),0x4,0x8,5,3,(&(parameterArrays[0])),0x4,0x4},{REMOTE_SCALARS_MAKEX(0,0,0x2,0x0,0x0,0x0),0x8,0x0,3,2,(&(parameterArrays[3])),0x4,0x0}};
static const Method* const methodArrays[9] = {&(methods[0]),&(methods[1]),&(methods[0]),&(methods[0]),&(methods[0]),&(methods[2]),&(methods[3]),&(methods[4]),&(methods[4])};
...
static const uint16_t methodStrings[19] = {42,101,106,89,0,101,106,21,101,106,62,106,89,95,82,111,126,116,121};
static const uint16_t methodStringsArrays[9] = {18,13,17,16,15,10,0,7,4};
...
__QAIC_STUB_EXPORT int __QAIC_STUB(hexref_cycle)(unsigned int cycles) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 1;
   return _stub_method_1(_hexref_handle(), _mid, (uint32_t*)&cycles);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(hexref_wait)(void) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
   return _stub_method(_hexref_handle(), _mid);
}
...
static __inline int _stub_method_4(remote_handle _handle, uint32_t _mid, uint32_t _in0[1], char* _in1[1], uint32_t _in1Len[1]) {
   remote_arg _pra[2];
   uint32_t _primIn[2];
   remote_arg* _praIn;
   int _nErr = 0;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(hexref_rpc_relay_port_write)(unsigned int port, const unsigned char* buff, int buffLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 7;
   return _stub_method_4(_hexref_handle(), _mid, (uint32_t*)&port, (char**)&buff, (uint32_t*)&buffLen);
}
