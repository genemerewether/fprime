...
static const char strings[86] = "rpc_relay_buff_read\0rpc_relay_port_read\0rpc_relay_write\0bytes\0buff\0port\0fini\0init\0run\0";
static const uint16_t methodStrings[14] = {0,67,62,56,20,67,62,56,40,67,62,72,82,77};
