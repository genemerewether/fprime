...
static __inline int _skel_method_3(int (*_pfn)(uint32_t), uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   uint32_t _in0[1];
   uint32_t* _primIn;
   int _nErr = 0;
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(hexref_skel_invoke)(uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc))
   {
      ...
      case 1:
      return _skel_method_3((void*)__QAIC_IMPL(hexref_cycle), _sc, _pra);
      case 2:
      return _skel_method_2((void*)__QAIC_IMPL(hexref_wait), _sc, _pra);
      case 3:
