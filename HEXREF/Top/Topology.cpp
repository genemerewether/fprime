...
void manualConstruct(void) {  
    ...
    kraitRouter_ptr->set_KraitPortsOut_OutputPort(8, cmdDisp_ptr->get_seqCmdBuff_InputPort(2));
    cmdDisp_ptr->set_seqCmdStatus_OutputPort(2, kraitRouter_ptr->get_HexPortsIn_InputPort(8));
