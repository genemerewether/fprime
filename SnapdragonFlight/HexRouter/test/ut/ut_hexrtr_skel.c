#ifndef _UT_HEXRTR_SKEL_H
#define _UT_HEXRTR_SKEL_H
#include "ut_hexrtr.h"
#ifndef _QAIC_ENV_H
#define _QAIC_ENV_H
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(ut_hexrtr_skel_invoke)(uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
