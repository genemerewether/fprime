#ifndef _DSP_RELAY_STUB_H
#define _DSP_RELAY_STUB_H
#include "dsp_relay.h"
#ifndef _QAIC_ENV_H
#define _QAIC_ENV_H
...
#ifndef _DSP_RELAY_SLIM_H
#define _DSP_RELAY_SLIM_H
#include "remote.h"
#include <stdint.h>
...
#ifndef _const_dsp_relay_handle
#define _const_dsp_relay_handle ((remote_handle)-1)
#endif //_const_dsp_relay_handle

static void _dsp_relay_pls_dtor(void* data) {
   remote_handle* ph = (remote_handle*)data;
   if(_const_dsp_relay_handle != *ph) {
      (void)__QAIC_REMOTE(remote_handle_close)(*ph);
      *ph = _const_dsp_relay_handle;
   }
}

static int _dsp_relay_pls_ctor(void* ctx, void* data) {
   remote_handle* ph = (remote_handle*)data;
   *ph = _const_dsp_relay_handle;
...
__QAIC_STUB_EXPORT remote_handle _dsp_relay_handle(void) {
   remote_handle* ph;
   if(adsp_pls_add_lookup) {
      if(0 == adsp_pls_add_lookup((uint32_t)_dsp_relay_handle, 0, sizeof(*ph),  _dsp_relay_pls_ctor, "dsp_relay",  _dsp_relay_pls_dtor, (void**)&ph))  {
         return *ph;
      }
      return (remote_handle)-1;
   } else if(HAP_pls_add_lookup) {
      if(0 == HAP_pls_add_lookup((uint32_t)_dsp_relay_handle, 0, sizeof(*ph),  _dsp_relay_pls_ctor, "dsp_relay",  _dsp_relay_pls_dtor, (void**)&ph))  {
         return *ph;
      }
      return (remote_handle)-1;
   }
...
uint32_t _dsp_relay_atomic_CompareAndExchange(uint32_t * volatile puDest, uint32_t uExchange, uint32_t uCompare);
...
__QAIC_STUB_EXPORT remote_handle _dsp_relay_handle(void) {
   static remote_handle handle = _const_dsp_relay_handle;
   if((remote_handle)-1 != handle) {
      return handle;
   } else {
      remote_handle tmp;
      int nErr = _dsp_relay_pls_ctor("dsp_relay", (void*)&tmp);
      if(nErr) {
         return (remote_handle)-1;
      }
      if(((remote_handle)-1 != handle) || ((remote_handle)-1 != (remote_handle)_dsp_relay_atomic_CompareAndExchange((uint32_t*)&handle, (uint32_t)tmp, (uint32_t)-1))) {
         _dsp_relay_pls_dtor(&tmp);
      }
      return handle;
   }
}
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_open)(int gpio) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 1;
   return _stub_method_1(_dsp_relay_handle(), _mid, (uint32_t*)&gpio);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_close)(int fd) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_configure)(int fd, int type) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 3;
   return _stub_method_2(_dsp_relay_handle(), _mid, (uint32_t*)&fd, (uint32_t*)&type);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_write)(int fd, int value) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 4;
   return _stub_method_2(_dsp_relay_handle(), _mid, (uint32_t*)&fd, (uint32_t*)&value);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_read)(int fd) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 5;
   return _stub_method_1(_dsp_relay_handle(), _mid, (uint32_t*)&fd);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_start_int)(int gpio, int fd) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 6;
   return _stub_method_2(_dsp_relay_handle(), _mid, (uint32_t*)&gpio, (uint32_t*)&fd);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_isr_wait)(int gpio, int fd) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 7;
   return _stub_method_2(_dsp_relay_handle(), _mid, (uint32_t*)&gpio, (uint32_t*)&fd);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_gpio_relay_quit)(int gpio) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 8;
   return _stub_method_1(_dsp_relay_handle(), _mid, (uint32_t*)&gpio);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_uart_relay_open)(int device) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 9;
   return _stub_method_1(_dsp_relay_handle(), _mid, (uint32_t*)&device);
}
static __inline int _stub_method_3(remote_handle _handle, uint32_t _mid, uint32_t _in0[1], uint32_t _in1[1], uint32_t _in2[1], uint32_t _in3[1], uint32_t _in4[1], uint32_t _in5[1], uint32_t _in6[1], uint32_t _in7[1]) {
   remote_arg _pra[1];
   uint32_t _primIn[8];
   int _nErr = 0;
   _pra[0].buf.pv = (void*)_primIn;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_uart_relay_configure)(int fd, int device, int baud, int parity, int bits, int stop_bits, int flow_control, int block) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 10;
   return _stub_method_3(_dsp_relay_handle(), _mid, (uint32_t*)&fd, (uint32_t*)&device, (uint32_t*)&baud, (uint32_t*)&parity, (uint32_t*)&bits, (uint32_t*)&stop_bits, (uint32_t*)&flow_control, (uint32_t*)&block);
}
static __inline int _stub_method_4(remote_handle _handle, uint32_t _mid, uint32_t _in0[1], char* _rout1[1], uint32_t _rout1Len[1], uint32_t _rout2[1]) {
   int _numIn[1];
   remote_arg _pra[3];
   uint32_t _primIn[2];
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_uart_relay_read)(int device, unsigned char* buff, int buffLen, int* bytes) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 11;
   return _stub_method_4(_dsp_relay_handle(), _mid, (uint32_t*)&device, (char**)&buff, (uint32_t*)&buffLen, (uint32_t*)bytes);
}
static __inline int _stub_method_5(remote_handle _handle, uint32_t _mid, uint32_t _in0[1], uint32_t _in1[1], char* _in2[1], uint32_t _in2Len[1]) {
   remote_arg _pra[2];
   uint32_t _primIn[3];
   remote_arg* _praIn;
   int _nErr = 0;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_uart_relay_write)(int fd, int device, const unsigned char* buff, int buffLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 12;
   return _stub_method_5(_dsp_relay_handle(), _mid, (uint32_t*)&fd, (uint32_t*)&device, (char**)&buff, (uint32_t*)&buffLen);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_uart_relay_close)(int fd, int device) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 13;
   return _stub_method_2(_dsp_relay_handle(), _mid, (uint32_t*)&fd, (uint32_t*)&device);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_uart_relay_quit)(int device) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 14;
   return _stub_method_1(_dsp_relay_handle(), _mid, (uint32_t*)&device);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_uart_receive_allocate)(int device, int size) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 15;
   return _stub_method_2(_dsp_relay_handle(), _mid, (uint32_t*)&device, (uint32_t*)&size);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_spi_relay_open)(int device) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 16;
   return _stub_method_1(_dsp_relay_handle(), _mid, (uint32_t*)&device);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_spi_relay_configure)(int fd, int clock) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 17;
   return _stub_method_2(_dsp_relay_handle(), _mid, (uint32_t*)&fd, (uint32_t*)&clock);
}
static __inline int _stub_method_6(remote_handle _handle, uint32_t _mid, uint32_t _in0[1], char* _in1[1], uint32_t _in1Len[1], char* _rout2[1], uint32_t _rout2Len[1]) {
   int _numIn[1];
   remote_arg _pra[3];
   uint32_t _primIn[3];
   remote_arg* _praIn;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_spi_relay_read_write)(int fd, const unsigned char* write_data, int write_dataLen, unsigned char* read_data, int read_dataLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 18;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_pwm_relay_open)(int device) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 24;
   return _stub_method_1(_dsp_relay_handle(), _mid, (uint32_t*)&device);
}
static __inline int _stub_method_8(remote_handle _handle, uint32_t _mid, uint32_t _in0[1], uint64_t _rout1[1], char* _in2[1], uint32_t _in2Len[1], uint32_t _in3[1]) {
   int _numIn[1];
   remote_arg _pra[3];
   uint32_t _primIn[3];
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_pwm_relay_configure)(int fd, uint64* handle, const unsigned int* channel, int channelLen, unsigned int period_in_usecs) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 25;
   return _stub_method_8(_dsp_relay_handle(), _mid, (uint32_t*)&fd, (uint64_t*)handle, (char**)&channel, (uint32_t*)&channelLen, (uint32_t*)&period_in_usecs);
}
static __inline int _stub_method_9(remote_handle _handle, uint32_t _mid, uint64_t _in0[1], char* _in1[1], uint32_t _in1Len[1], uint32_t _in2[1]) {
   remote_arg _pra[2];
   uint64_t _primIn[2];
   remote_arg* _praIn;
   int _nErr = 0;
...
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_pwm_relay_set_duty)(uint64 handle, const unsigned int* pulse_width_in_usecs, int pulse_width_in_usecsLen, unsigned int bitmask) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 26;
   return _stub_method_9(_dsp_relay_handle(), _mid, (uint64_t*)&handle, (char**)&pulse_width_in_usecs, (uint32_t*)&pulse_width_in_usecsLen, (uint32_t*)&bitmask);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(dsp_relay_pwm_relay_close)(int fd) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 27;
   return _stub_method_1(_dsp_relay_handle(), _mid, (uint32_t*)&fd);
}
#ifdef __cplusplus
