#ifndef __BLIMPHEXREF_COMPONENTS_HEADER__
#define __BLIMPHEXREF_COMPONENTS_HEADER__
void constructBLIMPHEXREFArchitecture(void);
void exitTasks(void);
...
#include <BLIMPHEXREF/Top/TargetInit.hpp>
