...
from fprime.gse.controllers import image_listener
...
class TopPanel(object):
    ...
    def __init__(self, parent, opts, wid, top=False):
        ...
        self.__img_listen = image_listener.ImageListener.getInstance()
        self.__img_listen.start_thread()
        #NOTE(mereweth) - when image_listener is refactored, remove this line:
        if top:
            self.__img_listen.start_thread_filler(opts)
    ...
    def exit(self):
        ...
        if self.__top:
          ...
          self.__img_listen.stop_thread()
          #NOTE(mereweth) - when image_listener is refactored, remove this line:
          self.__img_listen.stop_thread_filler()
    ...
    def __handle_exit(self):
        ...
        for p in self.__panels:
            ...
            elif isinstance(p, image_panel.ImagePanel):
                self.__img_listen.deleteObserver(p)
    ...
    def build_notebook(self,parent):
        ...
        self.__p11= nb.add('Image Stream')
