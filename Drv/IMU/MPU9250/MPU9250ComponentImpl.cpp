        ...
        if (context == MPU9250_SCHED_CONTEXT_OPERATE) {
            ...
            switch(m_initState) {
                ...
                case INIT_GEN_CONFIG:
                    ...
                    if ((OUTPUT_1KHZ_DLPF_ACCEL_92HZ_GYRO_184HZ == m_outMode) ||
                        (OUTPUT_1KHZ_DLPF_ACCEL_184HZ_GYRO_184HZ == m_outMode) ||
                        (OUTPUT_1KHZ_DLPF_ACCEL_460HZ_GYRO_184HZ == m_outMode)) {
                ...
                case INIT_ACCEL_CONFIG_2:
                    ...
                    if (OUTPUT_1KHZ_DLPF_ACCEL_92HZ_GYRO_184HZ == m_outMode) {
                        writeBuf[1] = MPU9250_BITS_ACCEL_BW_LTE_460HZ |
                                      MPU9250_BITS_ACCEL_DLPF_CFG_92HZ;
                    }
                    if (OUTPUT_1KHZ_DLPF_ACCEL_184HZ_GYRO_184HZ == m_outMode) {
                        writeBuf[1] = MPU9250_BITS_ACCEL_BW_LTE_460HZ |
                                      MPU9250_BITS_ACCEL_DLPF_CFG_184HZ;
                    }
